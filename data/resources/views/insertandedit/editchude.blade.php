              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                        <form method="post" action="/insertandedit/editchude/{{$category->id }}">
                          ...
                          <div class="col-md-3 pl-1">
                            <div class="form-group">
                              <label>STT:</label>
                              <input
                                class="form-control text-box single-line" name="id" value="{{ $category->id }}"
                               />
                            </div>
                          </div>
                          <div class="col-md-9 pl-1">
                            <div class="form-group" >
                              ...
                              <input
                                class="form-control text-box single-line" name="name" value="{{ $category->name }}"
                              />
                            </div>
                          </div>
                          <div class="mb-3">
